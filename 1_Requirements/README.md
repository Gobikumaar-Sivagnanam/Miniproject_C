...
| forward_difference.c | Doesn't take any arguement | Using a dataset with value and function at the respective value to find the numerical differentiation at a point using Newton's Forward difference formula |
